...
class FtpTarget:
    def __new__(
        cls, system_id: int, component_id: int, network_id: int = 0
    ) -> Self: ...
    @property
...
class FtpEntryKind:
    File: FtpEntryKind
    Directory: FtpEntryKind
    Skip: FtpEntryKind
    Unknown: FtpEntryKind
...
class FtpEntry:
    ...
    def name(self) -> str: ...
    @property
    def kind(self) -> FtpEntryKind: ...
    @property
    def size(self) -> int | None: ...

@final
class FtpOperationProgress:
    @property
    def phase(self) -> str: ...
    @property
...
@final
class FtpProgressSubscription(_AsyncSubscription[FtpOperationProgress]): ...

@final
class FtpDownloadOp:
    def latest(self) -> FtpOperationProgress | None: ...
    def subscribe(self) -> FtpProgressSubscription: ...
    def cancel(self) -> None: ...
    def wait(self) -> Coroutine[Any, Any, bytes]: ...
    def wait_timeout(self, timeout_secs: float) -> Coroutine[Any, Any, bytes]: ...
...
@final
class FtpHandle:
    def with_target(self, target: FtpTarget) -> FtpHandle: ...
    def list_directory(self, path: str) -> Coroutine[Any, Any, list[FtpEntry]]: ...
    def download(self, remote_path: str) -> FtpDownloadOp: ...
    def upload(self, remote_path: str, data: bytes) -> FtpUploadOp: ...
    def remove_file(self, path: str) -> Coroutine[Any, Any, None]: ...
    def create_directory(self, path: str) -> Coroutine[Any, Any, None]: ...
    def remove_directory(self, path: str) -> Coroutine[Any, Any, None]: ...
    def rename(self, from_path: str, to_path: str) -> Coroutine[Any, Any, None]: ...
    def truncate(self, path: str, length: int) -> Coroutine[Any, Any, None]: ...
    def crc32(self, path: str) -> Coroutine[Any, Any, int]: ...
